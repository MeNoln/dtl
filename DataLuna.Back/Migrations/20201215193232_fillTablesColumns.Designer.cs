...
namespace DataLuna.Back.Migrations
{
    ...
    [Migration("20201215193232_fillTablesColumns")]
    partial class fillTablesColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLuna.Back.Domain.FinishedMatch", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DataLuna.Back.Domain.GameDemo", b =>
                {
                    ...
                    b.Property<long>("FinishedMatchId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("FinishedMatchId");
            ...
            modelBuilder.Entity("DataLuna.Back.Domain.GameDemo", b =>
                {
                    b.HasOne("DataLuna.Back.Domain.FinishedMatch", "FinishedMatch")
                        .WithMany("GameDemos")
                        .HasForeignKey("FinishedMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
